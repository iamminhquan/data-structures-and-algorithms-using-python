...
def main() -> None:
    """
    Demonstrate basic operations of the :class:`SinglyLinkedList`.
    ...
    print("List after append:", linked_list)
    print("length:", len(linked_list))
    print()

    print("Prepend 5")
    linked_list.prepend(5)
    print("List after prepend:", linked_list)
    print("length:", len(linked_list))
    print()

    print("Insert 15 at index 2")
    linked_list.insert(2, 15)
    print("List after insert:", linked_list)
    print("length:", len(linked_list))
    print()

    print("Get value at index 2:", linked_list.get(2))
    print("List via iteration:", list(linked_list))
    print()

    print("Contains 20?", linked_list.contains(20))
    print("Contains 999?", linked_list.contains(999))
    print()

    print("Remove value 15")
    removed_success: bool = linked_list.remove(15)
    print("Removed:", removed_success)
    print("List after remove(15):", linked_list)
    print("length:", len(linked_list))
    print()

    print("Remove_at index 0")
    removed_head: int = linked_list.remove_at(0)
    print("Removed head value:", removed_head)
    print("List after remove_at(0):", linked_list)
    print("length:", len(linked_list))
    print()

    print("Clear the list")
    linked_list.clear()
    print("List after clear:", linked_list)
    print("is_empty():", linked_list.is_empty())
    print("length:", len(linked_list))
